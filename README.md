...
scripts/ui.js                  navigazione, tab, FAB e pulsanti +
scripts/assistant-contexts.js  testi e suggerimenti dell'assistente
scripts/context-assistant.js   interfaccia e chiamate a /api/chat
scripts/maps.js                mappe OpenStreetMap statiche
scripts/bundle.js              sessioni, analytics e waitlist
...
Quando aggiungi una nuova schermata contestuale:

1. aggiungi la sua associazione in `scripts/ui.js`;
2. aggiungi i testi visuali in `scripts/assistant-contexts.js`;
3. aggiungi il contesto sicuro per OpenAI in `api/_lib/contexts.js`.
