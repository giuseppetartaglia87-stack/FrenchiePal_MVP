...
const alertStateConfig = {
    stable: {
        ...
        iconContainerClass: 'flex h-14 w-14 items-center justify-center rounded-full border-2 border-sky-200 bg-sky-100 text-sky-700 shadow-sm transition-all duration-500',
        rr: '24',
        temp: '22 C',
        load: 'Basso',
    ...
    ivdd: {
        ...
        iconContainerClass: 'flex h-14 w-14 items-center justify-center rounded-full border-2 border-rose-300 bg-rose-100 text-rose-600 shadow-sm transition-all duration-500 scale-110',
        rr: '28',
        temp: '23 C',
        load: 'Picchi',
    ...
    baos: {
        ...
        iconContainerClass: 'flex h-14 w-14 items-center justify-center rounded-full border-2 border-amber-300 bg-amber-100 text-amber-600 shadow-sm transition-all duration-500 scale-110',
        rr: '38',
        temp: '31 C',
        load: 'Alta',
    ...
    derma: {
        ...
        iconContainerClass: 'flex h-14 w-14 items-center justify-center rounded-full border-2 border-fuchsia-300 bg-fuchsia-100 text-fuchsia-600 shadow-sm transition-all duration-500',
        rr: '24',
        temp: '22 C',
        load: 'Normale',
...
window.FrenchiePal.createDemoController = function createDemoController({ trackEvent, trackChatOpenOnce }) {
    ...
    function renderAlertState(type = 'stable') {
        if (!phoneFrame || !statusText || !alertIconContainer || !alertIcon || !alertTitle || !alertDesc || !valHeart || !valTemp || !valAct) {
        ...
        statusText.className = `text-[0.78rem] font-black uppercase tracking-[0.18em] ${config.statusClass}`;
    ...
    function setActiveScreen(screen) {
        ...
        [screenHome, screenDiary, screenDash, screenChat]
            .filter(Boolean)
        ...
        } else if (nextScreen === 'diary') {
            clearPhoneFrameAlertMode();
            screenDiary?.classList.add('active');
